    ...
    while l_frame is not None:
        ...
        while l_usr is not None:
            ...
            try:
                ...
                # (1, 57001, 1, 1) > (57001, 1, 1) > (batch_size, 1000, 57)。
                # out = out[:, 1:, ...].reshape(out.shape[0] , -1 , 57)   # or out.squeeze().out[:, 1:].reshape(out.shape[0] , -1 , 57)
                # ----------------------------------------------------------------------------------------------------------------------
...
def parse_args():
    ...
    parser.add_argument("-config", "--config-file", default='./configs/dstest1_pgie_YOLOv8-Pose_config.txt',
